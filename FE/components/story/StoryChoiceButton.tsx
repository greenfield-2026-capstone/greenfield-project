...
export function StoryChoiceButton({
  ...
  return (
    <button
      ...
      className={`group relative min-h-32 overflow-hidden rounded-3xl border p-4 text-left shadow-sm transition duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1f2a5c] disabled:cursor-not-allowed disabled:opacity-70 sm:p-5 ${
        selected
    ...
    >
      <span className="pointer-events-none absolute -right-10 -top-10 h-28 w-28 rounded-full bg-[#eef2fb] opacity-70 transition group-hover:scale-110" />
      <span className="relative flex items-center gap-3">
        ...
        >
          Choice {marker} · {toneLabel}
        </span>
      </span>
      <span className="relative mt-4 block text-base font-black leading-7">
        {choice.text}
      </span>
    </button>
  );
